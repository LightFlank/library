...
class Dataset(object):
    ...
    def eval2(
            self, model1: KBCModel, model2: KBCModel, split: str, n_queries: int = -1, missing_eval: str = 'both',
            at: Tuple[int] = (1, 3, 10), log_result=False, save_path=None
    ):
        model1.eval()
        model2.eval()
        ...
        for m in missing:
            ...
            # 获取两个模型的排名
            ranks = model1.get_ranking2(q, self.to_skip[m], batch_size=500,model2=model2)
